...
# 13 "Tn06.c"
volatile unsigned char keyout __attribute__((address(0xF8A)));
volatile unsigned char keyin __attribute__((address(0xF81)));
volatile unsigned char key_io __attribute__((address(0xF93)));
