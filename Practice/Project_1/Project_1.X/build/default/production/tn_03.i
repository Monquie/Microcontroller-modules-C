...
const unsigned char dl_rom[4][8] ={
...
unsigned char dl_ram[8],ramidx,romidx,so_ql;
...
void __attribute__((picinterrupt(("high_priority")))) int0_isr()
{
    INTCONbits.INT0IF = 0;
    doi_ql();
    xuatled();
...
{
    unsigned char dem;
    for(dem=0;dem<250;dem++) _delay((unsigned long)((2)*(10000000/4000.0)));
}
void main()
{
    init();
