...
# 1 "D:\\Setup\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\ctype.h" 1 3
# 10 "D:\\Setup\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\ctype.h" 3
int isalnum(int);
int isalpha(int);
int isblank(int);
int iscntrl(int);
...
int tolower(int);
int toupper(int);
# 41 "D:\\Setup\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\ctype.h" 3
# 1 "D:\\Setup\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\bits/alltypes.h" 1 3
# 419 "D:\\Setup\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\bits/alltypes.h" 3
typedef struct __locale_struct * locale_t;
# 41 "D:\\Setup\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\ctype.h" 2 3
...
int isascii(int);
int toascii(int);
# 2 "../MSSV-41203052.X/LCD.c" 2
# 11 "../MSSV-41203052.X/LCD.c"
const unsigned char dhbkstr[8][8]={
...
{ unsigned char j;
    i_write((unsigned char)((addr*8&0b00111111)|0b01000000));
    for(j=0;j<8;j++)
        d_write(data[j]);
}
#pragma interrupt_level 1
...
void lcd_DHBK(void)
{ unsigned char i;
    for(i=0;i<8;i++) lcd_download(i,dhbkstr[i]);
    lcd_gotoxy(1,8);
    for(i=0;i<8;i++) putch(i);
}
