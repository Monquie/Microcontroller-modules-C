...
# 1 "../MSSV-41203052.X/tn08.h" 1
# 10 "../MSSV-41203052.X/tn08.h"
extern void timer_process();
# 2 "../MSSV-41203052.X/Timer.c" 2
...
void __attribute__((picinterrupt(("high_priority")))) timer0_isr()
{
    if(TMR0IE & TMR0IF)
    {
        timer0_reset();
